...
import static com.mohraz.dev.jfx.mdialog.MDialogMessageType.*;
...
public class MDialogMessageViewController implements Initializable {
    ...
    private void initLook() {
        ...
        } else if (MDialogMessageType == DANGER) {
        ...
        } else if (MDialogMessageType == INFORMATION) {
        ...
        } else if (MDialogMessageType == SUCCESS) {
